...
let liRef = document.querySelectorAll('#categories .item'); 
console.log(`В списке ${liRef.length} категории`);
liRef.forEach((element)=> {
    console.log(`Категория: ${element.querySelector('h2').textContent}, Количество элементов: ${element.querySelector('ul').children.length}`)
}
)